...
router.post('/id/:pieceId/tags', authenticate, requireLibraryRole(), tagsController.attachTag);
router.delete('/id/:pieceId/tags', authenticate, requireLibraryRole(), tagsController.detachTag);

// piece comments: GET available to members; POST allowed to editor+ roles; PUT/DELETE for comment edit/delete
router.get('/id/:pieceId/comments', authenticate, commentsController.getComments);
router.post('/id/:pieceId/comments', authenticate, requireOrgRole(), commentsController.addComment);
router.put('/id/:pieceId/comments/:commentId', authenticate, commentsController.updateComment);
router.delete('/id/:pieceId/comments/:commentId', authenticate, commentsController.deleteComment);
