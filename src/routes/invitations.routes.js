...
router.post('/:organizationId/invite', authenticate, requireOrgRole(), invitationsController.createInvite)
...
router.post('/:inviteId/respond', authenticate, invitationsController.respondInvite)
